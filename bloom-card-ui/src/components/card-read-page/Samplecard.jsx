...
function Samplecard() {
  ...
  return (
    <div className={`font-sans antialiased leading-normal tracking-wider ${darkMode ? 'text-gray-100 bg-gray-900' : 'text-gray-900 bg-white'}`} style={{ backgroundImage: "url('https://source.unsplash.com/1L71sPT5XKc')" }}>
      <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
        ...
        <div className="absolute top-0 right-0 h-12 w-18 p-4">
          <button className="focus:outline-none" onClick={toggleDarkMode}>{darkMode ? '☀️' : '🌙'}</button>
        </div>
      </div>
    </div>
  );
